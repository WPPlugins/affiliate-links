...
<div id="af-link-wrap" style="display: none; margin-top: -200px" class="af-link">
    <div id="af-link">
        ...
        <div id="link-selector">
            ...
            <button id="af-link-submit" class="affiliate_links_copy button button-secondary hide-if-no-js" data-source="affiliate_links_embed_shortcode"><?php _e( 'Insert link', 'affiliate-links' ) ?></button>
        </div>
    </div>
</div>
...
class Affiliate_Links_Metabox {
	...
	public function add_meta_box( $post_type ) {
		...
		if ( in_array( $post_type, $post_types ) ) {
			...
			add_meta_box(
				'affiliate_links_sidebar',
				__( 'Information', 'affiliate-links' ),
	...
	public function stats_field( $post_id ) {
		...
		$count = esc_html( get_post_meta( $post_id, '_affiliate_links_stat', true ) );
		?>
		<tr>
			...
			<td>
				<?php if ( $count ) { ?>
					...
					<span class="affiliate_links_reset_button" data-meta="_affiliate_links_stat"
					      data-confirm="<?php _e( 'Are you sure?', 'affiliate-links' ) ?>">
                        <button type="button"
                                class="button button-small hide-if-no-js"><?php _e( 'Reset count', 'affiliate-links' ) ?></button>
                    </span>
				<?php } else { ?>
